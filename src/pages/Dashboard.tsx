...
export default function Dashboard() {
  ...
  const founderStats = [
    { label: 'New Requirements Today', value: 3, icon: Briefcase, color: 'text-indigo-600', bg: 'bg-indigo-100' },
    { label: 'Active Requirements', value: jobs?.length || 12, icon: Briefcase, color: 'text-indigo-600', bg: 'bg-indigo-100' },
    { label: 'Candidates Submitted', value: 32, icon: Users, color: 'text-blue-600', bg: 'bg-blue-100' },
    { label: 'Interview Scheduled', value: 5, icon: Zap, color: 'text-purple-600', bg: 'bg-purple-100' },
    { label: 'Offers Released', value: 2, icon: CheckCircle2, color: 'text-emerald-600', bg: 'bg-emerald-100' },
    { label: 'Placements', value: closedDeals || 1, icon: CheckCircle2, color: 'text-emerald-600', bg: 'bg-emerald-100' },
    { label: 'Pipeline Value', value: '₹38,50,000', icon: CircleDollarSign, color: 'text-emerald-600', bg: 'bg-emerald-100' },
    { label: 'Expected Margin', value: '₹9,25,000', icon: TrendingUp, color: 'text-indigo-600', bg: 'bg-indigo-100' },
    { label: 'Actual Margin', value: '₹8,50,000', icon: TrendingUp, color: 'text-emerald-600', bg: 'bg-emerald-100' },
    { label: 'Collections Due', value: '₹14,00,000', icon: Clock, color: 'text-orange-600', bg: 'bg-orange-100' },
    { label: 'Vendor Payables', value: '₹8,40,000', icon: Building2, color: 'text-rose-600', bg: 'bg-rose-100' },
  ];
          ...
          <div className="relative z-10 flex flex-col gap-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-white/10">
              <div>
                ...
                <h3 className="text-3xl text-white font-black tracking-tight mb-2">Business Health Score</h3>
              ...
              <div className="flex items-center justify-center bg-white/5 backdrop-blur-md rounded-2xl w-28 h-28 border border-white/10 shrink-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {founderStats.map((stat) => (
                <div key={stat.label} className="bg-white/5 p-4 rounded-2xl border border-white/10 flex flex-col justify-center gap-2">
                  <span className="text-slate-400 text-[10px] font-bold uppercase tracking-widest leading-tight">{stat.label}</span>
